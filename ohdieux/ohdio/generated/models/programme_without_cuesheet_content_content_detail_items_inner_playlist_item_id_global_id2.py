...
class ProgrammeWithoutCuesheetContentContentDetailItemsInnerPlaylistItemIdGlobalId2(BaseModel):
    """
    ProgrammeWithoutCuesheetContentContentDetailItemsInnerPlaylistItemIdGlobalId2
    """ # noqa: E501
    id: StrictStr
    content_type: ContentType = Field(alias="contentType")
    __properties: ClassVar[List[str]] = ["id", "contentType"]
