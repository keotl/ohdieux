...
class PlaylistItemItemsInnerPlaylistItemId(BaseModel):
    """
    PlaylistItemItemsInnerPlaylistItemId
    """ # noqa: E501
    media_id: StrictStr = Field(alias="mediaId")
    __properties: ClassVar[List[str]] = ["mediaId"]
